...
public class PassengerVehicle extends Vehicle {
	...
	public PassengerVehicle clone() {
		PassengerVehicle p = new PassengerVehicle(null, this.getSeatNumber());
		return p;
	}
	
	public void setCurrentNumberPassenger(int passengerNumber) {
		this.currentNumberPassenger = passengerNumber;
	}
